...
$bd = "ugblibreria";//nombre de base de datos
...
if(!$bd_conec) //confirma si no existe la base de datos
{
	...
	@mysql_query("create table if not exists empleado ( nombre_e1 varchar(20), nombre_e2 varchar(20),primer_ae varchar(20),segundo_ae varchar(20),fecha_nacimiento varchar(20), dui_e varchar(11) not null,nit varchar(16),dir_e varchar(50),  genero varchar(11),telefono varchar(11), primary key (dui_e))");
		...
		@mysql_query("create table if not exists venta (codigo_a varchar(5) not null, codigo_p varchar(10), nombre_art varchar(30),des varchar(50),cant int, fecha date, precio double, primary key (codigo_a))");
