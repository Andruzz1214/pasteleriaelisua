	...
	if(!$bd_conec) //confirma si no existe la base de datos
{
		...
		@mysql_query("create table if not exists venta (codigo_v varchar(5) not null, codigo_a varchar(10), nombre_art varchar(30),des varchar(50),cant int, fecha date, precio double, primary key (codigo_v)");
